...
quotes = [
  ...
  {
    quote:'The things we love destroy us every time.',
    author:''
  },
  {
  ...
  {
    quote:"A man who won't listen can't hear.",
    author:''
  },
  {
  ...
  {
    quote:"It was queer how sometimes a child's innocent eyes can see things that grown men are blind to.",
    author:''
  },
  {
    quote:"Only a man who's been burned knows what hell is truly like.",
    author:''
  },
  {
    quote:'Even in dreams, you could not fall forever.',
    author:''
  },
  {
    quote:"We only make peace with our enemies. That's why it's called making peace.",
    author:''
  },
  {
    quote:'In life, the monsters win.',
    author:''
  },
  {
  ...
  {
    quote:'It was bitingly cold up here, and the wind pulled at his clothes like an insistent lover.',
    author:''
  },
  {
    quote:"They hate you because you act like you're better than they are",
    author:''
  },
  {
    quote:'A mad man sees what he sees.',
    author:''
  },
  {
  ...
  {
    quote:'There are things to be learned even from the dead.',
    author:''
  },
  {
  ...
  {
    quote:'What the King dreams, the Hand builds.',
    author:''
  },
  {
  ...
  {
    quote:'Let them see that their words can cut you and you’ll never be free of the mockery.',
    author:''
  },
  {
    quote:'Armor yourself in it, and it will never be used against you',
    author:''
  },
  {
    quote:'None of us is ever ready, for death.',
    author:''
  },
  {
    quote:'A man who sees nothing has no use for his eyes.',
    author:''
  },
  {
    quote:'My words lied. My eyes and my arm shouted out the truth,but you were not seeing.',
    author:''
  },
  {
    quote:'A bastard had to learn to notice things, to read the truth that people hid behind their eyes.',
    author:''
  },
  {
    quote:'Power tastes best when sweetened by courtesy.',
    author:''
  },
  {
    quote:'Calm as still water. Strong as a bear. Fierce as a wolverine.',
    author:''
  },
  {
  ...
  {
    quote:'Where the king goes, the realm follows.',
    author:''
  },
  {
    quote:'The hard truths are the ones to hold tight.',
    author:''
  },
  {
    quote:'A man who fights for coin is loyal only to his purse.',
    author:''
  },
  {
    quote:'Some secrets are safer kept hidden. Some secrets are too dangerous to share with those you love and trust.',
    author:''
  },
  {
  ...
  {
    quote:'Every hurt is a lesson, and every lesson makes you better.',
    author:''
  },
  {
    quote:'My mind is my weapon.',
    author:''
  },
  {
    quote:'Life is not a song. You may learn that one day to your sorrow.',
    author:''
  },
  {
    quote:'Can a man still be brave if he’s afraid? That is the only time a man can be brave.',
    author:''
  },
  {
    quote:'You may be different as the sun and the moon, but the same blood flows through both your hearts.',
    author:''
  },
  {
    quote:'Grieve for your friend, but never blame yourself.',
    author:''
  },
  {
    quote:'A chain needs all sorts of metals, and a land needs all sorts of people.',
    author:''
  },
  {
    quote:'Be strong, boy. The gods are cruel.',
    author:''
  },
  {
    quote:'Some commands are more easily given than obeyed.',
    author:''
  },
  {
    quote:'When soldiers lack discipline, the fault lies with their lord commander.',
    author:''
  },
  {
    quote:'War should not be a game.',
    author:''
  },
  {
    quote:'Pain is a gift from the gods',
    author:''
  },
  {
    quote:'Expect nothing and you will never be surprised.',
    author:''
  },
  {
    quote:'The map was one thing and the land quite another.',
    author:''
  },
  {
    quote:'Lions care not for the opinions of sheep.',
    author:''
  },
  {
    quote:'Nothing holds an edge like Valyrian steel.',
    author:''
  },
  {
  ...
  {
    quote:'Choose. Fly or die.',
    author:''
  },
  {
    quote:"All things of importance in a man's life must be done beneath the open sky.",
    author:''
  },
  {
    quote:'The weight of armor and shield will tire even the strongest man.',
    author:''
  },
  {
    quote:'This was something different and deadlier: a dance where the smallest misstep meant death.',
    author:''
  },
  {
    quote:'Love is the bane of honor, the death of duty.',
    author:''
  },
  {
    quote:'The realm will rise for its rightful king.',
    author:''
  },
  {
    quote:'We are only human, and the gods have fashioned us for love. That is our great glory, and our great tragedy',
    author:''
  },
  {
    quote:'The man as asks the question must bear the answer.',
    author:''
  },
  {
    quote:'A lord needed to eat with his men, if he hoped to keep them.',
    author:''
  },
  {
    quote:'He must learn to face his fears. He will not be three forever. And winter is coming.',
    author:''
  },
  {
  ...
  {
    quote:'Here every castle had its godswood, and every godswood had its heart tree, and every heart tree its face.',
    author:''
  },
  {
    quote:'Even the truest knight cannot protect a king against himself.',
    author:''
  },
  {
    quote:'Sitting on a throne is a thousand times harder than winning one.',
    author:''
  },
  {
    quote:'I have a realistic grasp of my own strengths and weaknesses. My mind is my weapon.',
    author:''
  },
  {
    quote:'No one was safe. No life was certain.',
    author:''
  },
  {
    quote:'It is hard to take orders from a man you laughed at in your cups, Will reflected',
    author:''
  },
  {
    quote:'A commander needs a good battlefield voice',
    author:''
  },
  {
    quote:'This was something else: poison in the dark, a knife trust to the soul.',
    author:''
  },
  {
    quote:'Never draw your sword unless you mean to use it.',
    author:''
  },
  {
    quote:'My Throne is made from the swords of my enemies',
    author:''
  },
  {
    quote:'When dead men come hunting in the night, do you think it matters who sits the Iron Throne?',
    author:''
  },
  {
    quote:'A nightmare this might be, yet it was no dream.',
    author:''
  }
]
...
quotes = [
  ...
  # # },
  # {
  #   quote: "Basic, boring, regular things are waiting on someone to have incredible ideas about turning them into amazing opportunities. Greatness isn't hiding, it's right there.",
  #   author: ''
  # },
  # {
  ...
  # # },
  # {
  #   quote: 'Give people a reason to come to work, not just a place to go to work.',
  #   author: ''
  # },
  # {
  ...
  # },
  # {
  #   quote: 'Leaders have to set a tone of intolerance for anything that gets in the way of value.',
  #   author: ''
  # },
  # {
  ...
  # },
  # {
  #   quote: 'Big thinking precedes great achievement.',
  #   author: ''
  # },
  # {
  ...
  # },
  # {
  #   quote: "Start with the premise that anything is possible. There's an unlimited amount of opportunity in this universe.",
  #   author: ''
  # },
  # {
  ...
  # },
  # {
  #   quote: "The most important and most difficult project you will work on improving in this life, is you. It's about getting better.",
  #   author: ''
  # },
  # {
  #   quote: "When it's all said and done your goal is to have done more than said.",
  #   author: ''
  # },
  # {
  ...
  # },
  # {
  #   quote: 'My possibilities define you, not my problems.',
  #   author: ''
  # },
  # {
  ...
  # },
  # {
  #   quote: 'After the final "no" there comes a "yes" And on that yes the future world depends.',
  #   author: ''
  # },
  # {
  ...
  # },
  # {
  #   quote: "You have to be burning with an idea, or a problem. If you're not passionate enough from the start, you'll never stick it out.",
  #   author: ''
  # },
  # {
  ...
  # },
  # {
  #   quote: 'All you have to do is jump. Handwork and good faith will take care of the rest.',
  #   author: ''
  # },
  # {
  ...
  # },
  # {
  #   quote: 'If you want to build a ship, don’t drum up the to gather wood, divide the work and give orders. Instead, teach them to yearn for the vast and endless sea.',
  #   author: ''
  # },
  # # {
  ...
  # },
  # {
  # quote: "So many people are upset with their 9 to 5 but they are sleep right now. Theres something special about doing what you love and becoming who you are meant to be. Greatness will require you to demand more of yourself. Ask yourself what are you committed too? What are you risking?",
  # author: ''
  # },
  # {
